...
public class PeopleAssignments implements Externalizable {
	...
	@ManyToMany
	@JoinTable(name = "JBPM_PEOPLEASSIGNMENTS_POTOWNERS", joinColumns = @JoinColumn(name = "task_id"), inverseJoinColumns = @JoinColumn(name = "entity_id"))
	private List<OrganizationalEntity> potentialOwners = Collections
			.emptyList();

	@ManyToMany
	@JoinTable(name = "JBPM_PEOPLEASSIGNMENTS_EXCLOWNERS", joinColumns = @JoinColumn(name = "task_id"), inverseJoinColumns = @JoinColumn(name = "entity_id"))
	private List<OrganizationalEntity> excludedOwners = Collections.emptyList();

	@ManyToMany
	@JoinTable(name = "JBPM_PEOPLEASSIGNMENTS_STAKEHOLDERS", joinColumns = @JoinColumn(name = "task_id"), inverseJoinColumns = @JoinColumn(name = "entity_id"))
	private List<OrganizationalEntity> taskStakeholders = Collections
			.emptyList();

	@ManyToMany
	@JoinTable(name = "JBPM_PEOPLEASSIGNMENTS_BAS", joinColumns = @JoinColumn(name = "task_id"), inverseJoinColumns = @JoinColumn(name = "entity_id"))
	private List<OrganizationalEntity> businessAdministrators = Collections
			.emptyList();

	@ManyToMany
	@JoinTable(name = "JBPM_PEOPLEASSIGNMENTS_RECIPIENTS", joinColumns = @JoinColumn(name = "task_id"), inverseJoinColumns = @JoinColumn(name = "entity_id"))
	...
	public void setTaskInitiator(final User taskInitiator) {
	...
	public void setPotentialOwners(
	...
	public void setExcludedOwners(
			final List<OrganizationalEntity> excludedOwners) {
	...
	public void setBusinessAdministrators(
			final List<OrganizationalEntity> businessAdministrators) {
	...
	public void setRecipients(final List<OrganizationalEntity> recipients) {
	...
	public boolean equals(final Object obj) {
		...
		final PeopleAssignments other = (PeopleAssignments) obj;
