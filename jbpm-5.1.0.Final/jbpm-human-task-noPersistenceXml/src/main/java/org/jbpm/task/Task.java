...
public class Task implements Externalizable {
	...
	public void writeExternal(final ObjectOutput out) throws IOException {
		...
		for (final SubTasksStrategy strategy : subTaskStrategies) {
	...
	public void readExternal(final ObjectInput in) throws IOException,
		...
		final List<SubTasksStrategy> list = new ArrayList<SubTasksStrategy>(
				size);
		for (int i = 0; i < size; i++) {
			final String name = in.readUTF();
			final SubTasksStrategy strategy = SubTasksStrategyFactory
					.newStrategy(name);
	...
	public void setPeopleAssignments(final PeopleAssignments peopleAssignments) {
	...
	public void setDelegation(final Delegation delegation) {
	...
	public void setTaskData(final TaskData taskData) {
	...
	public void setDeadlines(final Deadlines deadlines) {
