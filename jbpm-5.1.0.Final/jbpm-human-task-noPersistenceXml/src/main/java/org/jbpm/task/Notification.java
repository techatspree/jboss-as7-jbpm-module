...
public class Notification implements Externalizable {
  ...
  @ManyToMany
  @JoinTable(name = "JBPM_NOTIFICATION_RECIPIENTS", joinColumns = @JoinColumn(name = "task_id"), inverseJoinColumns = @JoinColumn(
      name = "entity_id"))
  private List<OrganizationalEntity> recipients = Collections.emptyList();

  @ManyToMany
  @JoinTable(name = "JBPM_NOTIFICATION_BAS", joinColumns = @JoinColumn(name = "task_id"), inverseJoinColumns = @JoinColumn(
      name = "entity_id"))
  ...
  public void setBusinessAdministrators(final List<OrganizationalEntity> businessAdministrators) {
  ...
  public void setNames(final List<I18NText> names) {
    this.names = names;
  }
  ...
  public void setSubjects(final List<I18NText> subjects) {
  ...
  public void setDescriptions(final List<I18NText> descriptions) {
  ...
  public boolean equals(final Object obj) {
    ...
    return CollectionUtils.equals(businessAdministrators, other.businessAdministrators)
        && CollectionUtils.equals(documentation, other.documentation) && CollectionUtils.equals(recipients, other.recipients)
        && CollectionUtils.equals(descriptions, other.descriptions) && CollectionUtils.equals(names, other.names)
