...
public class Reassignment implements Externalizable {
	...
	@ManyToMany
	@JoinTable(name = "JBPM_REASSIGNMENT_POTENTIALOWNERS", joinColumns = @JoinColumn(name = "task_id"), inverseJoinColumns = @JoinColumn(name = "entity_id"))
	...
	public boolean equals(final Object obj) {
		...
		final Reassignment other = (Reassignment) obj;
		return CollectionUtils.equals(documentation, other.documentation)
